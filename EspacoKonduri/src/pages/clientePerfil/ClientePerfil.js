  ...
  return (
    <Container style={{ paddingTop: insets.top }}>
      <ScrollContainer
        ...
        refreshControl={
          <RefreshControl refreshing={atualizando} onRefresh={handleRefresh} colors={["#E67E22"]} tintColor="#E67E22" />
        }
      >
        <Header>
          {usuario?.foto ? (
            ...
            <AvatarPlaceholder onTouchEnd={handleTrocarFoto}>
              <Ionicons name="camera-outline" size={28} color="#E67E22" />
            </AvatarPlaceholder>
          )}
        ...
        <InfoCard>
          <ToggleRow>
            <ToggleTextGroup>
              ...
              <ToggleSubtitle>Receber avisos sobre seus pedidos</ToggleSubtitle>
            </ToggleTextGroup>
            <Switch
              value={notificacoesAtivadas}
              onValueChange={handleToggleNotificacoes}
              trackColor={{ false: '#E6DFD5', true: '#F5C99B' }}
              thumbColor={notificacoesAtivadas ? '#E67E22' : '#FFFFFF'}
            />
          </ToggleRow>
        </InfoCard>

        <EditButton onPress={() => setModalNomeVisivel(true)}>
          <Ionicons name="pencil-outline" size={16} color="#E67E22" />
        ...
        <EditButton onPress={() => setModalSenhaVisivel(true)}>
          <Ionicons name="lock-closed-outline" size={16} color="#E67E22" />
      ...
      <Modal visible={modalSenhaVisivel} transparent animationType="fade" onRequestClose={() => setModalSenhaVisivel(false)}>
        <ModalOverlay>
          <ModalContent>
            ...
            <ModalInputRow>
              <ModalInput value={senhaAtual} onChangeText={setSenhaAtual} placeholder="Digite sua senha atual" secureTextEntry autoCapitalize="none" />
            </ModalInputRow>
            <ModalLabel>Nova senha</ModalLabel>
            <ModalInputRow>
              <ModalInput value={novaSenha} onChangeText={setNovaSenha} placeholder="Mínimo 8 caracteres" secureTextEntry autoCapitalize="none" />
            </ModalInputRow>
            <ModalLabel>Confirme a nova senha</ModalLabel>
            <ModalInputRow>
              <ModalInput value={confirmarNovaSenha} onChangeText={setConfirmarNovaSenha} placeholder="Digite novamente" secureTextEntry autoCapitalize="none" />
            </ModalInputRow>
